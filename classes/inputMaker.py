...
class App(QtWidgets.QMainWindow, uiMainWindow):
    ...
    def getValues(self):
        self.paramChanger(['$pseudo_dir','$prefix','$outdir','$nstep','$restart_mode','$etot_conv_thr','$forc_conv_thr'],
                          [self.pseudo_dir.text(),self.prefix.text(),self.outdir.text(),self.nstep.text(),self.restart_mode.currentText(),self.etot_conv_thr.text(),self.forc_conv_thr.text()]);
        self.paramChanger(['$nat','$ntyp','$ecutwfc','$ecutrho','$input_dft','$occupations','$smearing','$degauss'],
                          [self.nat.text(),self.ntyp.text(),self.ecutwfc.text(),self.ecutrho.text(),self.input_dft.text(),self.occupations.currentText(),self.smearing.currentText(),self.degauss.text()])
        self.paramChanger(['$diagonalization','$mixing_mode','$mixing_beta','$conv_thr','$electron_maxstep','$scf_must_converge'],
                          [self.diagonalization.currentText(),self.mixing_mode.currentText(),self.mixing_beta.text(),self.conv_thr.text(),self.electron_maxstep.text(),self.scf_must_converge.currentText()])
